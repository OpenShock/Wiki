...
- <span style={{display: "inline-flex", alignItems: "center", gap: "7px"}}><img src="/static/icons/discord-blurple.svg" width="20px" /> Discord `millkox`</span>
- 🔗 Shop: [milkieverse.cc](https://milkieverse.cc)
- <span style={{display: "inline-flex", alignItems: "center", gap: "7px"}}><img src="/static/icons/discord-blurple.svg" width="20px" /> Discord Server:  [discord.milkieverse.cc](https://discord.milkieverse.cc) (via support system)</span>
