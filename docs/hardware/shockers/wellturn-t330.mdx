...
tags:
  ...
  - shockers
title: Wellturn T330
description: Wellturn T330 shocker — technically compatible, but RF-only and hard to get.
icon: Zap
---
...
<Callout type="error" title="Lack of dashboard support">
  Cannot be added on the dashboard (openshock.app) and only useable via rf commands through the
  terminal.
</Callout>

<Callout type="error" title="Highly priced">
