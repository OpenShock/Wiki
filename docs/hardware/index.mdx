...
| Ready to get started?                               | [OpenShock guides](/guides/openshock)     | End-to-end setup instructions                     |
| I plan to self-host everything                      | [Self-hosting guide](/guides/selfhosting) | Best selfhost practice and examples               |
...
3. A recommended shocker (CaiXianlin), see the supported list
