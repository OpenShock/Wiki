...
description: Pair your hub with Wi-Fi and your OpenShock account, then connect your first shocker.
icon: Play
---
...
<Callout type="info">
  Your shocker will remember the hub, so there is no need to pair it every time.
</Callout>
