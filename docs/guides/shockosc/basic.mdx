---
title: Basic Setup
description: Install and sign into ShockOSC, the OpenShock Desktop module that bridges OSC to your shockers.
icon: Settings
---
...
3. Create your Shock Group. _Everything is done in groups — it doesn't matter if it's only one shocker or multiple shockers._
   - Go to the **Group** tab.
   - Create a new group.
   - Give the group a name. _(This also defines the parameter name later used for your avatar.)_
   - Select what shocker is to be used with the group.
   - _Optionally you can override the default limits set in ShockOSC per group._
