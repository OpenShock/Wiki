...
5. Now set the RF TX Pin, that is the number of the IO pin that the RF antenna data is connected to. (default 12, for pishock boards that is 15), type in your pin and press Set to change it.
...
![Image "image"](../static/guides/first-setup/devicecontextmenu.png)  
